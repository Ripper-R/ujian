...
function deletecart(id){
    ...
    arrProduct[indexplihan].stock=arrProduct[indexplihan].stock +cart[indexcart].qty
    tampilkanawal(arrProduct)
    cart.splice(indexcart,1)
    document.getElementById('cart').innerHTML=Tampilkancart()
    console.log(arrProduct[indexplihan].stock)
}
...
let funBuy=(id)=>{
    ...
    {
        alert('stock abis')
        arrProduct[indexplihan].stock=0
    }
}
let payment=()=>{
